...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Arkco Corp., 130 w 37th st Ground floor
            New York, NY 10018.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Arkco, accessible from{" "}
            <a
              href="www.Arcko.nyc"
      ...
      <ul>
        <li>By email: Admin@arkco.nyc</li>
      </ul>
    </div>
  );
};
